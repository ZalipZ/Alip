...
if($#ARGV > 2) {
	...
	die("______________________________________________________________\n                  EDIT SCRIPT BY ALIP \n______________________________________________________________\nUse: webside.pl [url] [Conexoes] [pedidos por conexao] [IP falco]\n* [URL]| = http://144.76.38.238/\n* [conexoes]| = 400\n* [pedidos por conexao]| = 100\n* [localhost]| = 127.0.0.1\n______________________________________________________________\nEx: webside.pl http://144.76.38.238/ 400 100 127.0.0.1\n");
